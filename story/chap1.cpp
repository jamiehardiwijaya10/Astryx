...
int chap1d(){
    ...
    typing("Elias mendekati mereka dan mencoba untuk memulai percakapan. Namun, pria tersebut tiba-tiba menodong Elias dengan pisau yang ia bawa.", 40);
    typing("\"Siapa kau?\" tanya pria tersebut dengan suara yang kasar dan penuh curiga.", 40);
    typing("\"Aku...disini untuk pulang ke Morivelle...\" jawab Elias dengan suara yang gemetar.", 40);
    typing("\"Aku berasal dari Morivelle...\" lanjut Elias, mencoba untuk meyakinkan pria tersebut.", 40);
    typing("\"Aku datang dari Demirgus...\" tambah Elias, berharap bisa meyakinkan pria tersebut bahwa ia bukan ancaman bagi mereka.", 40);
    ...
    typing("Setelah beberapa saat, wanita tersebut terlihat puas dengan apa yang ia temukan di tangan Elias.", 40);
    typing("\"Setidaknya kau bukan bagian dari mereka...\" kata wanita tersebut dengan suara yang lebih lembut.", 40);
    typing("\"Tapi identitasmu...Kau harus ikut kami...\" lanjut wanita tersebut, mencoba untuk meyakinkan Elias untuk ikut dengan mereka.", 40);
    typing("\"Apa yang kamu lakukan Ririsa?\" tanya pria tersebut dengan suara yang kebingungan, terlihat tidak setuju dengan keputusan wanita tersebut.", 40);
    typing("\"Kau bilang kau datang dari Demirgus, bukan?\" kata wanita tersebut, mencoba untuk meyakinkan pria tersebut bahwa Elias bukan ancaman bagi mereka.", 40);
    typing("\"Kau juga bilang kau disini untuk pulang ke Morivelle, bukan?\" perjelas wanita tersebut.", 40);
    typing("\"Simpel, kesimpulannya dia adalah warga asli Morivelle yang pergi ke Demirgus untuk bekerja, tapi sekarang dia kembali lagi ke Morivelle...\" lanjut wanita tersebut, mencoba untuk meyakinkan pria tersebut bahwa Elias bukan ancaman bagi mereka.", 40);
    typing("\"Sebenarnya untuk berkuliah.\" kata Elias.", 40);
    Sleep(800);
    ...
    typing("\"Lihat...\" kata wanita tersebut, mencoba untuk meyakinkan pria tersebut bahwa Elias bukan ancaman bagi mereka.", 40);
    typing("Sang pria menurunkan pisaunya perlahan.", 40);
    typing("\"Baiklah.\" kata pria tersebut dengan suara yang masih ragu, namun terlihat lebih tenang daripada sebelumnya.", 40);
    typing("\"Maaf hehe..Suamiku ini agak paranoid soal keamanan, apalagi dengan kondisi sekarang.\" kata wanita tersebut, mencoba menenangkan Elias", 40);
    typing("\"Namaku Ririsa, ini suamiku, Darius.\" kata wanita tersebut, memperkenalkan dirinya dan suaminya kepada Elias.", 40);
    typing("\"Kau bisa ikut dengan kami. Untuk keamanan desa kami dan juga mungkin menjawab kebinguganmu.\" tegas Ririsa, mencoba untuk meyakinkan Elias untuk ikut dengan mereka.", 40);
    Sleep(800);
    ...
    typing("\"Bagaimana kamu...\" tanya Elias", 40);
    typing("\"Dari kondisimu dan penjelasanmu sudah cukup menggambarkan keadaanmu sekarang. Kau bingung dengan yang terjadi disini.\" Jawab Ririsa sebelum Elias mampu menyelesaikan pertanyaannya.", 40);
    typing("\"Kalian berasal dari desa? Seingatku tidak ada desa di area sini.\"", 40);
    typing("\"Sudah berapa lama kamu pergi dari Morivelle?\"", 40);
    typing("\"Hampir 5 tahun yang lalu\" Jawab Elias.", 40);
    typing("\"Hmm..Pantas saja. Kami memang belum ada 5 tahun yang lalu.", 40);
    typing("\"Jadi kalian...?\"\n");
    ...
    typing("\"Kenapa memangnya? Aku senang bicara dengan seseorang sebayaku. Jarang sekali aku punya temen wanita sebaya.\" Perjelas Ririsa dengan lebih ceria.", 40);
    ...
    typing("\"The Night Raiders? Village of Purification?\" Elias bertanya.", 40);
    typing("\"Ah..The Night Raiders adalah sebutan untuk kaum kami.\" Ririsa menjelaskan dengan ceria.", 40);
    typing("\"Kami kaum yang hidup nomaden. Kami hidup dari pulau ke pulau. Sekarang kami tinggal disini. Namun karena beberapa situasi dan kondisi saat ini, sepertinya kami akan terus tinggal disini.\" Tambah Ririsa dengan sedikit termenung.", 40);
    ...
    typing("\"Makhluk hidup yang terkontaminasi?\" tanya Elias dengan penasaran.", 40);
    ...
    typing("\"Bercak hitam?\" tanya Elias dengan penasaran.", 40);
    ...
    typing("\"The Red Tide? Apa itu?\" tanya Ririsa.", 40);
    ...
    typing("\"Oke deh, kita bisa bicarakan itu nanti. Intinya itulah kenapa nama desa ini Village of Purification.\" Lanjut Ririsa dengan ceria lagi.", 40);
    Sleep(800);
    ...
    typing("\"Gary, aku membawa teman baru. Dia bilang dia dari Morivelle.\" Kata Ririsa dengan ceria.", 40);
    typing("Seorang pria paruh baya dengan rambut panjang yang diikat ke belakang muncul dari dalam rumah dan menyambut Elias dengan ramah.", 40);
    ...
    typing("\"Jadi, warga asli Morivelle yang pergi keluar kota dan pulang tanpa tahu kabar keadaan kotanya. Kamu pasti hidup sendiri dan jauh dari Morivelle sangat lama.\" Kata Gary dengan nada yang penuh perhatian.", 40);
    typing("\"Emm...Bisa dibilang seperti itu.\" Terang Elias.", 40);
    typing("\"Ririsa, bisakah tunggu diluar dan beri aku waktu untuk berbicara dengan nona Morivelle ini", 40);
    typing("\"Tentu Gary. Aku tunggu diluar ya\" Kata Ririsa kepada Elias sambil keluar dengan tersenyum ria.", 40);
    ...
    typing("\"Emm...Namaku Elias Viremont. Aku lahir di Morivelle dan aku tumbuh disini sampai usiaku 18.", 40);
    typing("\"Saat itu aku mendapat beasiswa untuk berkuliah di Demirgus University.", 40);
    typing("\"Aku meninggalkan Morivelle untuk pendidikan tepatnya 5 tahun lalu dan saat itu semuanya normal.\"\n", 40);
    typing("\"Dan 5 tahun selanjutnya atau lebih tepatnya sekarang kau kesini untuk pulang namun semuanya tiba-tiba rusak.\" Tambah Gary memotong perkataan Elias.", 40);
    ...
    typing("Note : Yokai adalah makhluk halus dalam mitologi Jepang yang bisa merasuki manusia atau benda mati dan membuatnya menjadi jahat.", 40);
    Sleep(800);
    ...
    typing("\"Kami juga mempelajari situasi alam di sekitar sini\"", 40);
    typing("\"Keduanya berakhir nihil dan tidak ada yang bisa dijelaskan sesuai dengan pengetahuan kami\"", 40);
    Sleep(800);
    ...
    typing("\"Di Demirgus sesuatu yang merubah fenomena alam juga sedang terjadi, hanya saja tidak separah disini.\"", 40);
    typing("\"Secara teori, ini disebut sebagai The Red Tide. Sebuah fenomena dimana alam merubah dirinya sendiri menjadi sesuatu yang lebih berbahaya dan merusak.\"", 40);
    typing("\"The Red Tide bisa merubah segala sesuatu yang ada di alam, termasuk makhluk hidup, menjadi sesuatu yang lebih berbahaya dan merusak.\"", 40);
    typing("\"Fenomena ini bisa terjadi secara tiba-tiba dan menyebar dengan cepat.\"", 40);
    Sleep(800);
    ...
    typing("Elias tersenyum, kemudian ia meninggalkan rumah Gary.", 40);
    typing("Diluar Ririsa sudah menunggu dengan sangat ceria", 40);
    typing("\"Bagaimana pembicaraanmu dengan Gary?\" Tanya Ririsa dengan ceria.\n", 40);
    typing("Elias pun menceritakan pembicaraannya dengan Gary kepada Ririsa.", 40);
    Sleep(800);
